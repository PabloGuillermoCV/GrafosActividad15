...
public class ListaDoblementeEnlazada<E> implements PositionList<E>{
	...
	//ejercicios 13 y 14
	public void ejercicio13 (E a, E b){
		Iterator<E> it = this.iterator();
		DNode<E> elim = new DNode<E>();
		while(it.hasNext()){
			E e1 = it.next();
			E e2 = it.next();
			if(e1.equals(e2)){
				...
				catch (InvalidPositionException e){System.out.println("Se intentó eliminar una posicion fuera de la lista");}
			}
		}
	}
